...
const BookingsPage = async () => {
   ...
   const bookingConfirmed = bookings.filter(booking => isFuture(booking.date)); 
   const bookingFinished = bookings.filter(booking => isPast(booking.date)); 
